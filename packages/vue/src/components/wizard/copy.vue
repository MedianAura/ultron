    ...
    <div class="cellule-info">
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <table>
              <tr>
                <td>Source:</td><td>{{steps[sequence]['options']['from']}}</td>
              </tr>
              <tr>
                <td>Destination:</td><td>{{steps[sequence]['options']['to']}}</td>
              </tr>
              <tr>
                <td>Fichiers:</td><td>{{steps[sequence]['options']['mask']}}</td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <ul v-if="steps[sequence]['options']['excludeFolder']['sources']">
                    <li class="nav-item" v-for="(option) in steps[sequence]['options']['excludeFolder']['sources']" v-bind:key="option.id">
                      {{ option }}
                    </li>
                  </ul>
                  ...
                  <ul v-if="steps[sequence]['options']['excludeFolder']['dest']">
                    <li class="nav-item" v-for="(option) in steps[sequence]['options']['excludeFolder']['dest']" v-bind:key="option.id">
                      {{ option }}
                    </li>
                  </ul>
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <ul v-if="steps[sequence]['options']['excludeFile']['sources']">
                    <li class="nav-item" v-for="(option) in steps[sequence]['options']['excludeFile']['sources']" v-bind:key="option.id">
                      {{ option }}
                    </li>
                  </ul>
                  ...
                  <ul v-if="steps[sequence]['options']['excludeFile']['dest']">
                    <li class="nav-item" v-for="(option) in steps[sequence]['options']['excludeFile']['dest']" v-bind:key="option.id">
                      {{ option }}
                    </li>
                  </ul>
                </td>
...
export default class Copy extends Vue {
  ...
  get title () {
    return this.steps[this.sequence]['options']['title'] ? this.steps[this.sequence]['options']['title'] : 'Copy de fichier(S)'
  }
}

      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>
            <input
              readonly
              :value="steps[sequence]['options']['to']"
              type="email"
              class="form-control"
              id="dst"
            ...
            <div class="input-group mb-3">
              <input
                :value="additionalDest"
                ref="dstAddionnels"
                type="email"
                class="form-control"
                id="dst-add"
                placeholder="Destinataires additionnels"
        ...
        <tr>
          ...
          <td>
            <textarea
              :value="steps[sequence]['options']['text']"
              ref="mailText"
              class="form-control"
              id="mes"
              rows="5"
        ...
        <tr>
          ...
          <td>
            <textarea
              :value="steps[sequence]['options']['markdown']"
              ref="markdownText"
              class="form-control"
              id="markdown"
              rows="5"

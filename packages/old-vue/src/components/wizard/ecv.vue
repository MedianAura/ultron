    ...
    <div class="form-row">
      <div class="form-group col-md-12">
        <div class="form-group col-md-6">
          ...
          <input
            id="archiveExpirationDate"
            v-validate="{
              required: true,
              regex: /^((19\d{2})|(20\d{2}))-(((02)-(0[1-9]|[1-2][0-9]))|(((0(1|[3-9]))|(1[0-2]))-(0[1-9]|[1-2][0-9]|30))|((01|03|05|07|08|10|12)-(31)))$/,
            }"
            v-model="archiveExpirationDate"
            name="archiveExpirationDate"
        ...
        <div class="form-group col-md-6">
          ...
          <input
            v-validate="{ required: true, regex: /^[0-9]+.[0-9]+.[0-9]+.[0-9]+$/ }"
            id="archiveVersion"
            name="archiveVersion"
            v-model="archiveVersion"
            v-on:change="updateValues"
            type="text"
            class="form-control"
          />
